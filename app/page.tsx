  ...
  return (
   ...
   <div className="mt-52 w-full max-w-6xl mx-auto px-5 ">
    ...
    <div className="py-5 text-center">
      <p className={`${sora.className} whitespace-pre-wrap lg:text-md text-sm`}>Ayo coba aplikasi <span className="text-[#A78BFA]">eTaskify</span> biar semua tugasmu tercatat rapi dan kamu bisa fokus menyelesaikannya satu per satu. No more stress!. Yuk, coba mulai hari ini biar nggak ada yang kelewat lagi!</p>
    </div>
